...
module.exports = {
  ...
  ,listAccountValueUpdates: (accountId) => request(`/accounts/${accountId}/value-updates`)
  ,createAccountValueUpdate: (accountId, value, ts, note) => request(`/accounts/${accountId}/value-updates`, { method: "POST", data: { value, ts, note } })
  ,updateAccountValueUpdate: (accountId, updateId, value, ts, note) => request(`/accounts/${accountId}/value-updates/${updateId}`, { method: "PATCH", data: { value, ts, note } })
  ,deleteAccountValueUpdate: (accountId, updateId) => request(`/accounts/${accountId}/value-updates/${updateId}`, { method: "DELETE" })
